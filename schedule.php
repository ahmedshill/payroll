    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="updatedata.php" method="post">
                ...
                <div class="modal-footer">
                    <button type="submit" id="updatecode" name="updatecode" class="btn btn-primary btn-block">Update Data</button>
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                </div>
            </form>
        </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="deletedata.php" method="post">
                <div class="modal-body" id="delete_target">
                    <h4>Are You Sure You Want To Delete </h4>
                </div>
                <div class="modal-footer">
                    <button type="submit" id="deletecode" name="deletecode" class="btn btn-primary btn-block">Yes!! Delete Data</button>
...
<div class="container">
    ...
    <table class="table  table-hover table-secondary table-striped" rules="all">
        <thead>
        <tr>
            <th>ID</th>
            <th>Name</th>
...
<script>
    ...
    $(document).ready(function () {
        $('.deletebtn').on('click', function () {
            ...
            console.log(data[0]);
            $('#delete_target').html(`<input type=\"number\" value=${data[0]} name=\"delete_id\" hidden=\"true\">`);
